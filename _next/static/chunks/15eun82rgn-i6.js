(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,48268,e=>{"use strict";var t=e.i(43476),s=e.i(61881);e.s(["SpeakButton",0,function({text:e,language:r,className:a="",sentence:i=!1,rate:n,label:l="🔊",title:d="播放發音"}){return(0,t.jsx)("button",{type:"button",onClick:t=>{t.stopPropagation(),i?(0,s.speakSentence)(e,r,n):(0,s.speak)(e,r,n)},className:`text-muted hover:text-primary transition-colors shrink-0 ${a}`,"aria-label":`${d}：${e}`,title:d,children:l})}])},83479,37998,e=>{"use strict";e.s(["AUDIT_INFO",0,{updatesSinceAudit:10,lastAuditDate:"2026-08-23"}],83479);let t=`請對整個英文學習 App(D:\\FORCLAUDE\\英文學習)做一次全面體檢(全面稽核)。
